...
;
;void main (void) {
; 0000 00B1 void main (void) {
_main:
; 0000 00B2 
; 0000 00B3      int timer=1;
; 0000 00B4 
; 0000 00B5 
; 0000 00B6     Init_initController();
;	timer -> R16,R17
	__GETWRN 16,17,1
...
; 0000 00B9 
; 0000 00BA 
; 0000 00BB     while(TRUE){
_0x18:
; 0000 00BC 
; 0000 00BD 
; 0000 00BE 
; 0000 00BF         if(SW1 == 0)        // pressed
	SBIC 0x9,5
	RJMP _0x1B
; 0000 00C0         {
; 0000 00C1 
; 0000 00C2 
; 0000 00C3                     PORTB = 0x09;
	LDI  R30,LOW(9)
	CALL SUBOPT_0x0
; 0000 00C4                     delay_ms(timer);
; 0000 00C5                     PORTB = 0x08;
	LDI  R30,LOW(8)
	CALL SUBOPT_0x0
; 0000 00C6                     delay_ms(timer);
; 0000 00C7                     PORTB = 0x0C;
	LDI  R30,LOW(12)
	CALL SUBOPT_0x0
; 0000 00C8                     delay_ms(timer);
; 0000 00C9                     PORTB = 0x04;
	LDI  R30,LOW(4)
	CALL SUBOPT_0x0
; 0000 00CA                     delay_ms(timer);
; 0000 00CB                     PORTB = 0x06;
	LDI  R30,LOW(6)
	CALL SUBOPT_0x0
; 0000 00CC                     delay_ms(timer);
; 0000 00CD                     PORTB = 0x02;
	LDI  R30,LOW(2)
	CALL SUBOPT_0x0
; 0000 00CE                     delay_ms(timer);
; 0000 00CF                     PORTB = 0x03;
	LDI  R30,LOW(3)
	CALL SUBOPT_0x0
; 0000 00D0                     delay_ms(timer);
; 0000 00D1                     PORTB = 0x01;
	LDI  R30,LOW(1)
	RJMP _0x1E
; 0000 00D2                     delay_ms(timer);
; 0000 00D3 
; 0000 00D4         }
; 0000 00D5         else {
_0x1B:
; 0000 00D6                        // PORTB = 0X09;
; 0000 00D7                        // delay_ms(timer);
; 0000 00D8                        // delay_ms(1000);
; 0000 00D9 
; 0000 00DA 
; 0000 00DB                         PORTB = 0x01;
	LDI  R30,LOW(1)
	CALL SUBOPT_0x0
; 0000 00DC                         delay_ms(timer);
; 0000 00DD                         PORTB = 0x03;
	LDI  R30,LOW(3)
	CALL SUBOPT_0x0
; 0000 00DE                         delay_ms(timer);
; 0000 00DF                         PORTB = 0x02;
	LDI  R30,LOW(2)
	CALL SUBOPT_0x0
; 0000 00E0                         delay_ms(timer);
; 0000 00E1                         PORTB = 0x06;
	LDI  R30,LOW(6)
	CALL SUBOPT_0x0
; 0000 00E2                         delay_ms(timer);
; 0000 00E3                         PORTB = 0x04;
	LDI  R30,LOW(4)
	CALL SUBOPT_0x0
; 0000 00E4                         delay_ms(timer);
; 0000 00E5                         PORTB = 0x0C;
	LDI  R30,LOW(12)
	CALL SUBOPT_0x0
; 0000 00E6                         delay_ms(timer);
; 0000 00E7                         PORTB = 0x08;
	LDI  R30,LOW(8)
	CALL SUBOPT_0x0
; 0000 00E8                         delay_ms(timer);
; 0000 00E9                         PORTB = 0x09;
	LDI  R30,LOW(9)
_0x1E:
	OUT  0x5,R30
; 0000 00EA                         delay_ms(timer);
	MOVW R26,R16
	CALL _delay_ms
; 0000 00EB 
; 0000 00EC          }
